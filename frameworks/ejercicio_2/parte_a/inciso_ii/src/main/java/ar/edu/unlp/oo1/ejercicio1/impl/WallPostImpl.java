...
public class WallPostImpl implements WallPost {
	...
	public void setText(String text) {
		this.text = text;
		logger.info("Se escribio el texto " + text);
	}
	...
	@Override
	public void like() {
		logger.info("Se dio like");
		this.likes = this.likes + 1;
		if(this.likes == 10){
			logger.warning("Se alcanzaron los 10 likes");
		}
	}

	@Override
	public void dislike() {
		logger.info("Se dio dislike");
		if (likes > 0) {
			this.likes = this.likes - 1;
		}
		if(likes == 0){
			logger.warning("Se alcanzaron los 0 likes");
		}
